												...
												<h:panelGroup rendered="#{customHomeAction.rendere9}">
													<table align="center" width="100%">
														...
														<tr>
															...
															<td height="14px"
																style="text-align: top; no-repeat; font-size: 8px; color: maroon; padding-top: 0px;"
																colspan="8"><a4j:outputPanel>
																	...
																	<marquee behavior="scroll" direction="left"
																		...
																		<h:outputText escape="false"
																			...
																			style="FONT-SIZE: small; color: maroon; FONT-WEIGHT: bold;"></h:outputText>
																	</marquee>
																</a4j:outputPanel></td>
														</tr>
																						...
																						<table align="center" width="100%">
																							<tr>
																								<h:graphicImage height="180px" width="190px"
																									value="/images/yogiji.png"></h:graphicImage>
																							</tr>
																							<tr>
																								<td align="center" width="100%"><h:outputText
																										value="Changing horizon of the state capital under the visionary guidance of Hon'able Chief Minister Shri Yogi Adityanath."
																			...
																			<div style="border-width: 1px;">
																				<table cellspacing="0" cellpadding="0" width="100%">
																							...
																							<td align="center"><a4j:outputPanel
																									...
																									<table>
																										<tr style="#{customHomeAction.style}">
																											...
																											<a 
																												target="_self"
																												href="/portal/Home/Home/New+Scheme"> 
																													
																													 <h:graphicImage
																														rendered="#{customHomeAction.rendere1 and customHomeAction.regflg}"
																														height="120" width="100"
																														value="/icons/res.gif"></h:graphicImage> 
																											...
																											<h:graphicImage
																														rendered="#{customHomeAction.rendere1 and !customHomeAction.regflg}"
																														height="120" width="100"
																														value="/icons/resc.png"></h:graphicImage>
																											...
																											<td style="#{customHomeAction.style}"><a
																												target="_self"
																												href="/portal/Home/Home/Duplicate_Allotment_Letter"> <h:graphicImage
																														rendered="#{customHomeAction.rendere1}"
																														height="120" width="100"
																														value="/icons/al.png"></h:graphicImage>
																											</a> <br /></td>

																											<td style="#{customHomeAction.style}"><a
																												target="_blank"
																												href="http://pg.ldaonline.in"> <h:graphicImage
																														rendered="#{customHomeAction.rendere1}"
																														height="120" width="100"
																														value="/icons/gr.png"></h:graphicImage>
																											</a></td>
																											...
																											<td style="#{customHomeAction.style}">
																												...
																												<a target="_blank"
																												href="https://upobps.in/"> <h:graphicImage
																														rendered="#{customHomeAction.rendere1}"
																														height="120" width="100"
																					...
																					width="100" value="/icons/Publicunauthorised.png"></h:graphicImage>-->
																														...
																														<a target="_blank" 
																														href="http://www.tenderwizard.com/LDA">
																															<h:graphicImage
																																rendered="#{customHomeAction.rendere1 and customHomeAction.eaucflg}"
																																height="120" width="100"
																																value="/icons/eauco.png">
																															</h:graphicImage>
																											...
																											<td style="#{customHomeAction.style}"><b><a
																												target="_blank"
																												href="http://ebs.in/lda/public/">  
																														<h:graphicImage height="120"
																															rendered="false"
																															width="100"
																															value="/images/ST.png"></h:graphicImage>
																												</a>
																												
																												<h:graphicImage
																																rendered="true"
																																height="120" width="100"
																																value="/images/STC.png">
																															</h:graphicImage>
...
<td style="#{customHomeAction.style}"> <a
																												target="_blank"
																												href="https://etender.up.nic.in/"> <b>
																														<h:graphicImage height="120"
																															rendered="#{customHomeAction.rendere1}"
																															width="100"
																															value="/images/ET.png"></h:graphicImage>
																												</b> </a></td>
